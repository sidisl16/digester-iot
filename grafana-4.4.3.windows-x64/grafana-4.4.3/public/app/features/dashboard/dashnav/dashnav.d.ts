...
export declare class DashNavCtrl {
    ...
    titleTooltip: string;
    /** @ngInject */
    constructor($scope: any, $rootScope: any, dashboardSrv: any, $location: any, playlistSrv: any, backendSrv: any, $timeout: any, datasourceSrv: any, navModelSrv: any, contextSrv: any);
    toggleSideMenu(): void;
